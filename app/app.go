...
import (
	...
	examplevessmodule "examplevess/x/examplevess"
	examplevessmodulekeeper "examplevess/x/examplevess/keeper"
	examplevessmoduletypes "examplevess/x/examplevess/types"
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		examplevessmodule.AppModuleBasic{},
...
func New(
	...
	keys := storetypes.NewKVStoreKeys(
		...
		group.StoreKey, consensusparamtypes.StoreKey,
		examplevessmoduletypes.StoreKey,
	...
	*/
	...
	app.ExampleVeSsKeeper = *examplevessmodulekeeper.NewKeeper(
		appCodec,
		keys[examplevessmoduletypes.StoreKey],
		keys[examplevessmoduletypes.MemStoreKey],
		app.GetSubspace(examplevessmoduletypes.ModuleName),
	)
	examplevessModule := examplevessmodule.NewAppModule(appCodec, app.ExampleVeSsKeeper, app.AccountKeeper, app.BankKeeper)
	voteExtHandler := NewVoteExtensionHandler()
	voteExtHandler.SetHandlers(bApp)
	voteExtHandler.SetKeeper(app.ExampleVeSsKeeper)
	// voteExtOp := func(bApp *baseapp.BaseApp) {
	// 	voteExtHandler := NewVoteExtensionHandler()
	// 	voteExtHandler.SetHandlers(bApp)
	// }
	...
	app.bm.RegisterLegacyAminoCodec(cdc)
	...
	app.mm.SetOrderBeginBlockers(
		...
		examplevessmoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(examplevessmoduletypes.ModuleName)
